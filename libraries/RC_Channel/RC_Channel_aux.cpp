...
void RC_Channel_aux::aux_servo_function_setup(void)
{
    ...
    case RC_Channel_aux::k_flaperon2:
        set_angle_out(4500);
        break;
    case RC_Channel_aux::k_demanded_yaw_rate:
